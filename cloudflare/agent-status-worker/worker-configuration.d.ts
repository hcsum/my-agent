/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/agent-status-worker/wrangler.jsonc cloudflare/agent-status-worker/worker-configuration.d.ts` (hash: e778a1207f3e0eb7eccef05d96f3bb8f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STALE_AFTER_SECONDS" | "OFFLINE_AFTER_SECONDS">> {}
}
