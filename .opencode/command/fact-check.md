...
Load the visual-explainer skill and fact-check the document named by `$ARGUMENTS`. If no argument is given, use the most recently modified HTML file in `~/.agent/diagrams/`.
