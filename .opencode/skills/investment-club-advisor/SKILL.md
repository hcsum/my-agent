...
- **The user's reality** (the `## Reality` section of `notes/profile.md`, already in your context): between jobs, income matters, has savings but wants no zero-income state. Weight advice toward this risk reality — do NOT just mirror the club's aggressive 投机 tier.
